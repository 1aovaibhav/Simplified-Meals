...
function Hero() {
return (
    <div className='flex flex-col h-fit w-[80vw] mx-auto justify-around items-center py-40'>
        <h2 className='font-stylish tracking-widest text-3xl py-4 text-[#ffffff] font-medium'>
            Because your plate deserves options
        </h2>
        <h1 className='font-heading text-6xl py-6 text-[#efbd41] font-bold w-[80%] mx-auto text-center leading-16'>
            Bringing You The Best Food Choices, Whenever You're Hungry.
        </h1>
        <p className=' text-[#FFFFFF] font-para text-xl w-[60%] text-center font-light py-3 pb-15'>
        ...
        <button 
                      class=" relative h-[50px] w-[170px] text-[1.2rem] bg-red-600 text-white border-[3px] border-red-600 
