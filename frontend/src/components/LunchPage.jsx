 ...
 console.log(auth.user);
  ...
  try {
    ...
    const res = await axios.post("https://simplified-meals.onrender.com/api/v1/order/place", {
      ...
      messId: anmolId,
      items: [{ name: `${days[dayOfWeek]}'s Lunch`, price: pmess1?.[dayOfWeek], qty: Number(qty) }],
  ...
  try {
    const res = await axios.post("https://simplified-meals.onrender.com/api/v1/order/place", {
      ...
      messId: krihsnaId,
      mealType: "lunch",
      items: [{ name: `${days[dayOfWeek]}'s Lunch`, price: pmess2?.[dayOfWeek], qty: Number(qty) }],
  ...
  try {
    const res = await axios.post("https://simplified-meals.onrender.com/api/v1/order/place", {
      ...
      messId: shyamId,
      mealType: "lunch",
      items: [{ name: `${days[dayOfWeek]}'s Lunch`, price: pmess3?.[dayOfWeek], qty: Number(qty) }],
    ...
    <div className="w-[90%] md:w-[80%] py-12">
      ...
      <div className="flex flex-col gap-8">
        ...
        <div className="w-full bg-[#1e1e1e] rounded-lg px-4 sm:px-8 md:px-10 py-4">
          ...
          <p className="text-heading text-sm text-neutral-400">Timing - 12:30 p.m. - 2:00 p.m.</p>
